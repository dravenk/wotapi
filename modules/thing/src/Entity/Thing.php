...
namespace Drupal\thing\Entity;

use Drupal\Core\Entity\EntityStorageInterface;
use Drupal\Core\Field\BaseFieldDefinition;
use Drupal\Core\Entity\ContentEntityBase;
use Drupal\Core\Entity\EntityTypeInterface;
use Drupal\thing\ThingInterface;
 ...
 *   You can see this in the entity.thing.canonical
 *   route in the thing.routing.yml file. The view can be
 ...
 * @ContentEntityType(
 *   id = "thing",
 *   label = @Translation("Thing entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\thing\Entity\Controller\ThingListBuilder",
 *     "form" = {
 *       "default" = "Drupal\thing\Form\ThingForm",
 *       "delete" = "Drupal\thing\Form\ThingDeleteForm",
 *     },
 *     "access" = "Drupal\thing\ThingAccessControlHandler",
 *   },
 *   list_cache_contexts = { "user" },
 *   base_table = "thing",
 *   admin_permission = "administer thing entity",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 *     "uuid" = "uuid"
 ...
 *     "delete-form" = "/thing/{thing}/delete",
 *     "collection" = "/thing/list"
 *   },
 *   field_ui_base_route = "thing.thing_settings",
 * )
 *
 ...
 *
 * Example: 'entity.thing.canonical'.
 *
 * See the routing file at thing.routing.yml for the
 * corresponding implementation.
 *
 * The Thing class defines methods and fields for the thing entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see ThingInterface) also exposes the EntityOwnerInterface.
...
class Thing extends ContentEntityBase implements ThingInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Thing entity.'))
      ->setReadOnly(TRUE);

    // Standard field, unique outside of the scope of the current project.
    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Thing entity.'))
      ->setReadOnly(TRUE);
