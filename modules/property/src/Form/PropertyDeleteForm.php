...
/**
 * Provides a form for deleting a property entity.
 *
 * @ingroup property
 */
class PropertyDeleteForm extends ContentEntityConfirmFormBase {
   ...
   * {@inheritdoc}
   *
   * If the delete command is canceled, return to the property list.
   */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('property')->notice('@type: deleted %title.',
      [
        '@type' => $this->entity->bundle(),
        '%title' => $this->entity->label(),
      ]);
    $form_state->setRedirect('entity.property.collection');
  }
