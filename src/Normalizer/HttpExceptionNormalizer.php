...
use Drupal\wotapi\Normalizer\Value\HttpExceptionNormalizerValue;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\HttpKernel\Exception\HttpException;

/**
 * Normalizes an HttpException in compliance with the WOT:API specification.
 *
...
class HttpExceptionNormalizer extends NormalizerBase {
   ...
   *
   * @see https://www.drupal.org/project/wotapi/issues/2832211#comment-11826234
   *
   * @internal
   */
