 ...
 * @see wotapi.api.php
 *
 * @see \Drupal\wotapi\Revisions\VersionNegotiatorInterface
 */
class VersionNegotiator {
   ...
   *
   * @var \Drupal\wotapi\Revisions\VersionNegotiatorInterface[]
   */
   ...
   *
   * @param \Drupal\wotapi\Revisions\VersionNegotiatorInterface $version_negotiator
  ...
  public function addVersionNegotiator(VersionNegotiatorInterface $version_negotiator, $negotiator_name) {
    assert(strpos(get_class($version_negotiator), 'Drupal\\wotapi\\') === 0, 'Version negotiators are not a public API.');
