 ...
 * @see wotapi.api.php
 *
 * @see \Drupal\wotapi\Revisions\VersionNegotiator
 */
interface VersionNegotiatorInterface {
   ...
   *
   * The WOT:API module exposes revisions in terms of RFC5829. As such, the
   ...
   *
   * @throws \Drupal\wotapi\Revisions\VersionNotFoundException
   *   When the revision does not exist.
   * @throws \Drupal\wotapi\Revisions\InvalidVersionIdentifierException
