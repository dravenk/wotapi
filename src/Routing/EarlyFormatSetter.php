...
/**
 * Sets the 'api_json' format for requests to WOT:API resources.
 *
 * Because this module places all WOT:API resources at paths prefixed with
 * /wotapi, and therefore not shared with other formats,
 ...
 * throw exceptions, we'd like the error response to be in WOT:API format as
 ...
 * running any other filters, which is the case for WOT:API resources per
 * above.
 *
 * @internal
 */
