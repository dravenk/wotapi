...
//  use EntityValidationTrait;
   ...
   *   The current user account.
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, EntityFieldManagerInterface $field_manager, ResourceTypeRepositoryInterface $resource_type_repository, RendererInterface $renderer, EntityRepositoryInterface $entity_repository, TimeInterface $time, AccountInterface $user) {
...
//      $count_query = $this->getCollectionCountQuery($resource_type, [], $count_query_cacheability);
...
//    }
    ...
    $response = $this->respondWithCollection($primary_data,null,null);
//    $response = $this->respondWithCollection(null, $request, $resource_type);
...
//    $response = $this->respondWithCollection(null, $request, $resource_type,null);
    return $response;
  }
...
//    $response->addCacheableDependency($cacheability);
  ...
  protected function respondWithCollection(ResourceObjectData $primary_data,  Request $request, ResourceType $resource_type) {
    ...
    $collection_links = self::getPagerLinks($request, 1, $link_context);
