...
//use Drupal\wotapi\JsonApiResource\IncludedData;
//use Drupal\wotapi\JsonApiResource\LinkCollection;
//use Drupal\wotapi\JsonApiResource\NullIncludedData;
//use Drupal\wotapi\JsonApiResource\ResourceIdentifier;
//use Drupal\wotapi\JsonApiResource\Link;
//use Drupal\wotapi\JsonApiResource\ResourceObject;
//use Drupal\wotapi\JsonApiResource\ResourceObjectData;
...
//use Drupal\wotapi\JsonApiResource\Data;
//use Drupal\wotapi\JsonApiResource\JsonApiDocumentTopLevel;
...
//  use EntityValidationTrait;
   ...
   *   The current user account.
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, EntityFieldManagerInterface $field_manager, ResourceTypeRepositoryInterface $resource_type_repository, RendererInterface $renderer, EntityRepositoryInterface $entity_repository,SerializerInterface $serializer, TimeInterface $time, AccountInterface $user) {
  ...
  public function patchIndividual(ResourceType $resource_type, EntityInterface $entity, Request $request) {
    if ($entity instanceof RevisionableInterface && !($entity->isLatestRevision() && $entity->isDefaultRevision())) {
      throw new BadRequestHttpException('Updating a resource object that has a working copy is not yet supported. See https://www.drupal.org/project/wotapi/issues/2795279.');
    }
   ...
   * @param \Drupal\Core\Entity\EntityInterface $entity
   *   The requested entity.
   * @param \Drupal\wotapi\JsonApiResource\ResourceIdentifier[] $resource_identifiers
   ...
   *
   * @param \Drupal\wotapi\JsonApiResource\ResourceIdentifier $resource_identifier
   ...
   * @param \Symfony\Component\HttpFoundation\Request $request
   *   The request object.
   * @param \Drupal\wotapi\JsonApiResource\IncludedData $includes
   ...
   * @param \Drupal\wotapi\JsonApiResource\LinkCollection $links
   ...
   *
   * @param \Drupal\wotapi\JsonApiResource\ResourceObjectData $primary_data
   *   The collection of entities.
   * @param \Drupal\wotapi\JsonApiResource\IncludedData|\Drupal\wotapi\JsonApiResource\NullIncludedData $includes
   ...
   * @param \Symfony\Component\HttpFoundation\Request $request
   *   The request object.
   * @param \Drupal\wotapi\JsonApiResource\ResourceObject|\Drupal\wotapi\JsonApiResource\ResourceObjectData $data
   *   The response data from which to resolve includes.
   *
   * @return \Drupal\wotapi\JsonApiResource\Data
   ...
   *
   * @return \Drupal\wotapi\JsonApiResource\LinkCollection
