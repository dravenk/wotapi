...
/**
 * Represents a WOT:API resource identifier object.
 *
...
class ResourceIdentifier implements ResourceIdentifierInterface {
  ...
  /**
   * Gets the ResourceIdentifier's WOT:API resource type name.
   *
   * @return string
   *   The WOT:API resource type name.
   */
   ...
   * @param \Drupal\wotapi\WotApiResource\ResourceIdentifier $b
   ...
   *
   * @return \Drupal\wotapi\WotApiResource\ResourceIdentifier[]
