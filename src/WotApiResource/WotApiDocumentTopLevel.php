...
class WotApiDocumentTopLevel {
   ...
   *
   * @param \Drupal\wotapi\WotApiResource\ResourceIdentifierInterface|\Drupal\wotapi\WotApiResource\Data||\Drupal\Core\Field\EntityReferenceFieldItemListInterface $data
  ...
  public function __construct($data,  LinkCollection $links) {
    assert($data instanceof ResourceIdentifierInterface || $data instanceof Data || $data instanceof EntityReferenceFieldItemListInterface);
